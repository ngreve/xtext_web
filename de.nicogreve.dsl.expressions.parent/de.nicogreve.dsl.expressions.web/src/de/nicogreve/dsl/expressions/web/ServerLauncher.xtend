 ...
 * Just execute it and point a web browser to http://localhost:8090/
 */
class ServerLauncher {
	def static void main(String[] args) {
		...
		server.handler = new WebAppContext => [
			...
			setAttribute(WebInfConfiguration.CONTAINER_JAR_PATTERN, '.*/de\\.nicogreve\\.dsl\\.expressions\\.web/.*,.*\\.jar')
